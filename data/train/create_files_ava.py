...
print('after ava_included_timestamps_v2.2.txt')
...
shutil.copyfile(original, target)
print('after ava_train_excluded_timestamps_v2.2.csv')
...
print('after ava_train_v2.2.csv')
...
print('after ava_train_predicted_boxes.csv')
...
print('after ava_val_predicted_boxes.csv')
