...
_C.DA.ENABLE = False
_C.DA.AUX = False
_C.DA.AUX_TEST = False
_C.DA.CLASSES = 0
_C.DA.DATASET = "da"
_C.DA.FRAME_DIR = "/srv/beegfs02/scratch/da_action/data/kinetics700/frames/"
_C.DA.LABEL_MAP_FILE = "ava_action_list_v2.2.pbtxt"
_C.DA.FRAME_LIST_DIR = "/srv/beegfs02/scratch/da_action/data/kinetics700/frame_lists_10_5_2/"
_C.DA.ANNOTATION_DIR = "/srv/beegfs02/scratch/da_action/data/kinetics700/annotations_10_5_2/"
_C.DA.TRAIN_LISTS = ["train.csv"]
_C.DA.TEST_LISTS = ["val.csv"]
_C.DA.EXCLUSION_FILE = "kinetics_val_excluded_timestamps_v2.1.csv"
_C.DA.DETECTION_SCORE_THRESH = 0.8
_C.DA.TRAIN_GT_BOX_LISTS = []
_C.DA.TEST_GT_BOX_LISTS = []
_C.DA.TRAIN_PREDICT_BOX_LISTS = ["kinetics_train_predicted_boxes.csv"]
_C.DA.TEST_PREDICT_BOX_LISTS = ["kinetics_val_predicted_boxes.csv"]
_C.DA.GROUNDTRUTH_FILE = "kinetics_val_v2.1.csv"
_C.DA.FULL_TEST_ON_VAL = True
_C.DA.WEIGHT_MAIN = 0.5
_C.DA.WEIGHT_AUX = 0.5
_C.DA.LR_FACTOR = 10.0
_C.DA.F_CONFUSION = -1
...
# Luca: folder name for train checkpoint files
#_C.TRAIN.CHECKPOINT_SUBFOLDER = ""
...
# Luca Sieber where gt and detections shall be saved
_C.TEST.DETECTIONS_PATH = ""
_C.TEST.GT_PATH = ""

# Total mini-batch size
_C.TEST.BATCH_SIZE = 8 #luca changed from 8 to 1
...
# Luca Sieber freeze all but last layer
_C.MODEL.FREEZE_TO = -1
_C.MODEL.LAST_PRE_TRAIN = ""
...
_C.AVA.FRAME_DIR = "/srv/beegfs02/scratch/da_action/data/ava/frames/"
...
#)
_C.AVA.FRAME_LIST_DIR = (
    "/srv/beegfs02/scratch/da_action/data/ava/frame_lists/"
)
...
_C.AVA.ANNOTATION_DIR = (
    "/srv/beegfs02/scratch/da_action/data/ava/annotations_v2.2/"
)
...
_C.AVA.TEST_PREDICT_BOX_LISTS = ["ava_test_predicted_boxes.csv"]
...
_C.AVA.LABEL_MAP_FILE = "ava_action_list_v2.2.pbtxt"
