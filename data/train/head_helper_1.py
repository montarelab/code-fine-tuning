...
class ResNetRoIHead(nn.Module):
    ...
    def __init__(
        ...
        # Luca Sieber addition for domain adaptation
        self.da_classes = da_classes
        if da_classes > 0:
            self.projection2 = nn.Linear(sum(dim_in), da_classes, bias=True)
