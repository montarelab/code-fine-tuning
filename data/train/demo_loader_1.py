...
class VideoManager:
    ...
    def __init__(self, cfg):
        ...
        self.id = -1
        self.buffer = [] # list of frames that are not thrown away after creating one clip
    ...
    def __next__(self):
        ...
        if was_read and self.buffer_size != 0:
            self.buffer = frames[-self.buffer_size :] # negative addressing to get the last elements of the list
