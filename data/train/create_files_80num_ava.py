...
CLASSES_JSON = [i + 1 for i in range(80)]
...
annot_dir = work_dir + '/' + '80_annotations_' + config_name
frame_list_dir = work_dir + '/' + '80_frame_lists_' + config_name
...
reduce_pbtxt_write_json(orig_annot=orig_annot, annot_dir=annot_dir, classes=CLASSES_JSON)
