...
def train_epoch(
    ...
    for cur_iter, (inputs, labels, _, meta) in enumerate(train_loader):
        ...
        if cfg.DA.F_CONFUSION != -1 and cur_iter % cfg.DA.F_CONFUSION == 0:
    ...
    misc.plot_confusion_matrix(cm=cm, normalize=False,
...
def train_aux(cfg):
    ...
    # Create the video train and val loaders.
    train_loader = loader.construct_loader_da(cfg, "da_train")
    precise_bn_loader = (
